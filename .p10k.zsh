# Generated by Powerlevel10k configuration wizard on 2023-05-07 at 12:50 +04.
...
function prompt_username() {
  p10k segment -t '%F{34}%n %F{32}on %F{34}%m'
}

typeset -g POWERLEVEL9K_USERNAME_FOREGROUND=34
